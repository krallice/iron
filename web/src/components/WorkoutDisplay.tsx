...
const WorkoutDisplay: React.FC<WorkoutDisplayProps> = ({ workoutProgram }) => {
  ...
  return (
    <div className="bg-card rounded-lg p-6 border border-border/50 animate-fade-in">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-medium">Generated Workout Program</h2>
      ...
      <div className="workout-pre pre-scrollable">
        <pre ref={textRef}>{workoutProgram}</pre>
      </div>
    </div>
  );
};
